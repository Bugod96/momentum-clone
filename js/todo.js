...
const deleteAllToDosBtn = document.querySelector(".js-deleteAllToDosBtn");
...
const deleteToDo = (event) => {
  ...
  const li = btn.parentNode; // console.dir로 확인된 클릭된 버튼의 부모태그 => <li>~</li> 선택.
  toDoList.removeChild(li); // <ul class="js-toDoList"></ul>에 대해 특정 자식태그 <li>~</li>를 삭제.
...
const initToDos = () => {
  ...
  deleteAllToDosBtn.addEventListener("click", deleteAllTodos);
};
